...
export const MATH_SYMBOLS: MathSymbol[] = [
  // Structures
  { label: 'Frazione', latex: '\\frac{}{}', group: 'Strutture', keywords: ['frac', 'frazione', 'divisione', '/'], preview: '\\frac{\\square}{\\square}' },
  { label: 'Radice quadrata', latex: '\\sqrt{}', group: 'Strutture', keywords: ['sqrt', 'radice', 'root'], preview: '\\sqrt{\\square}' },
  { label: 'Radice n-esima', latex: '\\sqrt[]{}', group: 'Strutture', keywords: ['sqrt', 'radice', 'nth', 'root'], preview: '\\sqrt[\\square]{\\square}' },
  ...
  { label: 'Matrice 2x2', latex: '\\begin{pmatrix} {} & {} \\\\\\\\ {} & {} \\end{pmatrix}', group: 'Strutture', keywords: ['matrix', 'matrice', 'pmatrix'], preview: '\\begin{pmatrix}\\square&\\square\\\\\\square&\\square\\end{pmatrix}' },
  { label: 'Binomiale', latex: '\\binom{}{}', group: 'Strutture', keywords: ['binom', 'binomiale', 'coefficiente'], preview: '\\binom{n}{k}' },
  ...
  { label: 'Unione grande', latex: '\\bigcup_{}^{} {}', group: 'Insiemi', keywords: ['bigcup', 'unione', 'famiglia'], preview: '\\bigcup_{\\square}^{\\square} \\square' },
  { label: 'Intersezione grande', latex: '\\bigcap_{}^{} {}', group: 'Insiemi', keywords: ['bigcap', 'intersezione', 'famiglia'], preview: '\\bigcap_{\\square}^{\\square} \\square' },
  ...
  // Analysis
  { label: 'Integrale', latex: '\\int_{}^{} {}', group: 'Analisi', keywords: ['int', 'integrale', 'integral'], preview: '\\int_{\\square}^{\\square} \\square' },
  { label: 'Integrale indefinito', latex: '\\int ', group: 'Analisi', keywords: ['int', 'integrale', 'indefinito'] },
  { label: 'Integrale doppio', latex: '\\iint_{} {}', group: 'Analisi', keywords: ['iint', 'doppio', 'double'], preview: '\\iint_{\\square} \\square' },
  { label: 'Integrale di linea', latex: '\\oint_{} {}', group: 'Analisi', keywords: ['oint', 'linea', 'circuitazione'], preview: '\\oint_{\\square} \\square' },
  { label: 'Sommatoria', latex: '\\sum_{}^{} {}', group: 'Analisi', keywords: ['sum', 'somma', 'sommatoria', 'serie', 'sigma'], preview: '\\sum_{\\square}^{\\square} \\square' },
  { label: 'Produttoria', latex: '\\prod_{}^{} {}', group: 'Analisi', keywords: ['prod', 'produttoria', 'product'], preview: '\\prod_{\\square}^{\\square} \\square' },
  { label: 'Limite', latex: '\\lim_{{} \\to {}} {}', group: 'Analisi', keywords: ['lim', 'limite', 'limit'], preview: '\\lim_{\\square \\to \\square} \\square' },
  { label: 'Derivata', latex: '\\frac{d{}}{d{}}', group: 'Analisi', keywords: ['der', 'derivata', 'derivative'], preview: '\\frac{df}{dx}' },
  { label: 'Derivata parziale', latex: '\\frac{\\partial {}}{\\partial {}}', group: 'Analisi', keywords: ['partial', 'parziale', 'derivata'], preview: '\\frac{\\partial f}{\\partial x}' },
  ...
  // Functions
  { label: 'Seno', latex: '\\sin\\left({}\\right)', group: 'Funzioni', keywords: ['sin', 'seno'], preview: '\\sin(\\square)' },
  { label: 'Coseno', latex: '\\cos\\left({}\\right)', group: 'Funzioni', keywords: ['cos', 'coseno'], preview: '\\cos(\\square)' },
  { label: 'Tangente', latex: '\\tan\\left({}\\right)', group: 'Funzioni', keywords: ['tan', 'tangente'], preview: '\\tan(\\square)' },
  { label: 'Arcotangente', latex: '\\arctan\\left({}\\right)', group: 'Funzioni', keywords: ['arctan', 'arcotangente'], preview: '\\arctan(\\square)' },
  { label: 'Logaritmo', latex: '\\log_{} {}', group: 'Funzioni', keywords: ['log', 'logaritmo'], preview: '\\log_{\\square} \\square' },
  { label: 'Logaritmo naturale', latex: '\\ln\\left({}\\right)', group: 'Funzioni', keywords: ['ln', 'naturale', 'neperiano'], preview: '\\ln(\\square)' },
  ...
  { label: 'Massimo', latex: '\\max\\left({}\\right)', group: 'Funzioni', keywords: ['max', 'massimo'], preview: '\\max(\\square)' },
  { label: 'Minimo', latex: '\\min\\left({}\\right)', group: 'Funzioni', keywords: ['min', 'minimo'], preview: '\\min(\\square)' },
  { label: 'Estremo superiore', latex: '\\sup_{} {}', group: 'Funzioni', keywords: ['sup', 'estremo superiore'], preview: '\\sup_{\\square} \\square' },
  { label: 'Estremo inferiore', latex: '\\inf_{} {}', group: 'Funzioni', keywords: ['inf', 'estremo inferiore'], preview: '\\inf_{\\square} \\square' },
